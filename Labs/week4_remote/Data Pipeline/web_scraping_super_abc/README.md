web scraping super abc
==============================

Criacao de uma ETL que ira buscar diariamente os dados dos produtos presentes no ecommerce superabc.com.br
...
------------
    ...
        ├── self.py      <- All parameters of the execution
